...
if veriset is None:
    ...
    data = xr.open_dataset(f'{esapath}{testcase}/verification/set{veriset}/data_initguess.nc')
...
if veriset is None:
    ...
    data.to_netcdf(f'{esapath}{testcase}/verification/set{veriset}/data_interpolated.nc')
