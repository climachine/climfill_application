...
intp = xr.open_mfdataset(f'{esapath}{testcase}/verification/set?/data_interpolated_tmp.nc')
fill = xr.open_mfdataset(f'{esapath}{testcase}/verification/set?/data_climfilled_tmp.nc')
...
plt.savefig('verification_newold.png')
